...
export default class Teceze extends Component {
  constructor(props) {
    super(props);
    this.state = {
      PageData: [],
  ...
  componentDidMount() {
    ...
    /* WebApi.getRequest(
      "https://drupal2.24livehost.com/10"
    ).then((response) => {
  ...
  render() {
    ...
    return (
      <div id="page" className="site">
        <MetaTags>
          <title>TECEZE - IT Company - Drupal Dotsquares</title>
          <meta property="og:locale" content="en_US" />
          <meta property="og:type" content="article" />
          <meta
            property="og:title"
            content="TECEZE - IT Company - Drupal Dotsquares"
          />
          <meta
            property="og:description"
            content="TECEZE is a managed IT service provider company which provides on-site, private cloud or hybrid services, and cyber security services to the companies(all public &amp; private) in the United Kingdom. With TECEZE you will get a proactive Defence for Your Valued IT Infrastructure."
          />
          <meta
            property="og:url"
            content="https://drupal.dotsquares.com/teceze/"
          />
          <meta property="og:site_name" content="Drupal Dotsquares" />
          <meta
            property="article:modified_time"
            content="2021-08-09T11:38:42+00:00"
          />
          <meta
            property="og:image"
            content="https://drupal.dotsquares.com/wp-content/uploads/2021/07/01.jpg"
          />
...
export const loadData = () => {
  return Promise.all([HomeServices.getCaseStudyData(10)]);
};

export const getMetaData = () => {
  return HomeServices.getMetaData("teceze");
};
