...
export default class Nhtsa extends Component {
  constructor(props) {
    super(props);
    this.state = {
      PageData: [],
  ...
  componentDidMount() {
    ...
    /* WebApi.getRequest(
      "https://drupal2.24livehost.com/9"
    ).then((response) => {
  ...
  render() {
    ...
    return (
      <div id="page" className="site">
        <MetaTags>
          <title>
            National Highway Traffic Safety Administration - Drupal Dotsquares
          </title>
          <meta property="og:locale" content="en_US" />
          <meta property="og:type" content="article" />
          <meta
            property="og:title"
            content="National Highway Traffic Safety Administration - Drupal Dotsquares"
          />
          <meta
            property="og:description"
            content="NHTSA wanted a fully functional, friendly, fast, efficient and within budget as well as visually appealing website that will offer a positive experience to their customers."
          />
          <meta
            property="og:url"
            content="https://drupal.dotsquares.com/nhtsa/"
          />
          <meta property="og:site_name" content="Drupal Dotsquares" />
          <meta
            property="article:modified_time"
            content="2021-08-09T11:41:48+00:00"
          />
          <meta
            property="og:image"
            content="https://drupal.dotsquares.com/wp-content/uploads/2021/07/03.jpg"
          />
                ...
                <div className="wrapper">
                  <div className="drupal-row drupal-align-items-center">
                    ...
                    <div className="drupal-col-6 content-part-right">
                      {PageData.length > 0 && (
                        <h4>
                          A Background on National Highway Traffic Safety
                          Administration – <span>NHTSA</span>
                        </h4>
                        // <h4
                        //   dangerouslySetInnerHTML={{
...
export const loadData = () => {
  return Promise.all([HomeServices.getCaseStudyData(9)]);
};
