...
export default class Medipro extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    /* WebApi.getRequest(
      "https://drupal2.24livehost.com/11"
    ).then((response) => {
          ...
          <div id="primary" className="content-area">
            <main id="main" className="site-main">
              ...
              <div className="header-title">
                <h1>Medipro Aesthetics – Hair & Beauty Store</h1>
              </div>
              {/* headbanner  */}
                ...
                <div className="wrapper">
                  <div className="drupal-row drupal-align-items-center">
                    ...
                    <div className="drupal-col-6 content-part-right">
                      {PageData.length > 0 && (
                        <h4>
                          About - <span>Medipro Aesthetics</span>
                        </h4>
                        // dangerouslySetInnerHTML={{
...
export const loadData = () => {
  return Promise.all([HomeServices.getCaseStudyData(11)]);
};

export const getMetaData = () => {
  return HomeServices.getMetaData("medipro-aesthetics");
};
