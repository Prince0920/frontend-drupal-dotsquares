...
import CaseStudyList from "./elements/CaseStudyList";
  ...
  render() {
    ...
    return (
      <div id="page" className="site">
        <MetaTags>
          <title>
            Featured Case Studies - Dotsquares | Drupal Development Company
          </title>
          <meta
            name="description"
        ...
        <div className="site-content" id="content">
          <div id="primary" className="content-area">
            <main id="main" className="site-main">
              ...
              <CaseStudyList />
              <FormSection parentCallback={this.handleCallback} />
            </main>
          </div>
        </div>
        <Footer />
...
export const loadData = () => {
  return Promise.all([HomeServices.getCaseStudy()]);
};

export const getMetaData = () => {
  return HomeServices.getMetaData("case-studies");
};
